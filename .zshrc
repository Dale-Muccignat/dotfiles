...
export ZSH="/home/mirage_neos/.oh-my-zsh"
...
alias dotfilesadd='dotfiles add .config/picom .config/i3blocks .config/i3status .config/i3 .config/ranger .emacs.d .ssh/config .lyx .zshenv .zshrc'
## sshfs
