...
alias dotfilesadd='dotfiles add .julia/config/startup.jl .config/picom .config/i3blocks .config/i3status .config/i3 .config/ranger .emacs.d .ssh/config .lyx .zshenv .zshrc'
## sshfs
