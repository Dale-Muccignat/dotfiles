...
(use-package julia-mode
  ...
  ;; (let ((sysimg-file "/home/mirage_neos/.julia/config/custom_sysimage.so"))
  ;;   (when (file-exists-p sysimg-file)
  ;;     (setq julia-repl-switches "-i --color=yes --sysimage=/home/mirage_neos/.julia/config/custom_sysimage.so")))
...
;;  :load-path (lambda () (concat "julia-funcobs"))
 ;; :bind (:map my/julia-ext-map
